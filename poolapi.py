...
async def read_screenlogic(ip=GATEWAY_IP, disp_msg=None, logger=None):
    '''
...
async def set_heat_mode_pool(ip=GATEWAY_IP, mode=0, disp_msg=None, logger=None):
    '''
...
async def set_heat_mode_spa(ip=GATEWAY_IP, mode=0, disp_msg=None, logger=None):
    '''
...
async def set_spa_temp(ip=GATEWAY_IP, desired_temp=100, disp_msg=None, logger=None):
    '''
...
async def set_pool_temp(ip=GATEWAY_IP, desired_temp=84, disp_msg=None, logger=None):
    '''
...
# --------------------------------------------------------------------------------
def test_spa_on_off(ip=GATEWAY_IP, disp_msg=None, logger=None):
    '''
...
def main(ip=GATEWAY_IP, disp_msg=None, logger=None):
    '''
    get the current settings for the passed in device
    '''
    
    result_keys, result_values = asyncio.run(read_screenlogic(ip, disp_msg=disp_msg, logger=logger))
    return result_values, result_keys
